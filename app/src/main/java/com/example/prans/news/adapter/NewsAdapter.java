...
import com.example.prans.news.util.DateFormat;
...
public class NewsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        switch (news.getType()) {
            case NEWS_IMAGE_TYPE:
                ...
                ((NewsWithImageViewHolder) viewHolder).desc.setText(news.getDescription());
                ((NewsWithImageViewHolder) viewHolder).author.setText(news.getmAuthor());
                ((NewsWithImageViewHolder) viewHolder).source.setText(news.getSource().getName());;
                ((NewsWithImageViewHolder) viewHolder).time.setText(" \u2022 " + DateFormat.DateToTimeFormat(news.getPublishedAt()));
                ((NewsWithImageViewHolder) viewHolder).published_at.setText(DateFormat.DateFormat(news.getPublishedAt()));
                Picasso.get()
    ...
    public class NewsWithImageViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_news_with_image_item, desc, source, time, published_at, author;
        ImageView iv_news;
